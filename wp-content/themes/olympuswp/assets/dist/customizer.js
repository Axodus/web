(window["webpackJsonp_olympuswp"] = window["webpackJsonp_olympuswp"] || []).push([["style-customizer"],{
...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_olympuswp"] = window["webpackJsonp_olympuswp"] || [];
...
(function ($, api) {
  api.bind('ready', function () {
     ...
     */
    api.control('olympus_settings[add_retina_logo]', function (control) {
      var toggleControl = function toggleControl(value) {
        if (true === value) {
          api.control('olympus_settings[retina_logo]').toggle(true);
        } else {
          api.control('olympus_settings[retina_logo]').toggle(false);
        }
      };
    ...
    api.control('olympus_settings[add_sticky]', function (control) {
      var toggleControl = function toggleControl(value) {
        if (true === value) {
          api.control('olympus_settings[add_sticky_shadow]').toggle(true);
          api.control('olympus_settings[sticky_breakpoint]').toggle(true);
          api.control('olympus_settings[sticky_background]').toggle(true);
          api.control('olympus_sticky_links_color_wrapper').toggle(true);
          api.control('olympus_settings[sticky_style]').toggle(true);
          api.control('olympus_settings[sticky_logo]').toggle(true);
          api.control('olympus_settings[sticky_retina_logo]').toggle(true);
          api.control('olympus_settings[sticky_logo_width]').toggle(true);
        } else {
          api.control('olympus_settings[add_sticky_shadow]').toggle(false);
          api.control('olympus_settings[sticky_breakpoint]').toggle(false);
          api.control('olympus_settings[sticky_background]').toggle(false);
          api.control('olympus_sticky_links_color_wrapper').toggle(false);
          api.control('olympus_settings[sticky_style]').toggle(false);
          api.control('olympus_settings[sticky_logo]').toggle(false);
          api.control('olympus_settings[sticky_retina_logo]').toggle(false);
          api.control('olympus_settings[sticky_logo_width]').toggle(false);
        }
      };
    ...
    api.control('olympus_settings[add_breadcrumbs]', function (control) {
      var toggleControl = function toggleControl(value) {
        if (true === value) {
          api.control('olympus_page_header_breadcrumbs_text_separator_color_wrapper').toggle(true);
          api.control('olympus_page_header_breadcrumbs_links_wrapper').toggle(true);
        } else {
          api.control('olympus_page_header_breadcrumbs_text_separator_color_wrapper').toggle(false);
          api.control('olympus_page_header_breadcrumbs_links_wrapper').toggle(false);
        }
      };
    ...
    api.control('olympus_settings[search_style]', function (control) {
      var selectControl = function selectControl(value) {
        if ('none' === value) {
          api.control('olympus_settings[search_source]').toggle(false);
        } else {
          api.control('olympus_settings[search_source]').toggle(true);
        }

        if ('dropdown' === value) {
          api.control('olympus_settings[search_dropdown_heading]').toggle(true);
          api.control('olympus_settings[search_dropdown_bg]').toggle(true);
          api.control('olympus_search_dropdown_input_wrapper').toggle(true);
          api.control('olympus_search_dropdown_input_border_wrapper').toggle(true);
        } else {
          api.control('olympus_settings[search_dropdown_heading]').toggle(false);
          api.control('olympus_settings[search_dropdown_bg]').toggle(false);
          api.control('olympus_search_dropdown_input_wrapper').toggle(false);
          api.control('olympus_search_dropdown_input_border_wrapper').toggle(false);
        }

        if ('full-screen' === value) {
          api.control('olympus_settings[search_fullscreen_heading]').toggle(true);
          api.control('olympus_settings[search_fullscreen_design_heading]').toggle(true);
          api.control('olympus_settings[search_fullscreen_bg]').toggle(true);
          api.control('olympus_settings[search_fullscreen_title_color]').toggle(true);
          api.control('olympus_search_fullscreen_input_wrapper').toggle(true);
          api.control('olympus_search_fullscreen_input_border_wrapper').toggle(true);
          api.control('olympus_search_fullscreen_close_btn_wrapper').toggle(true);
        } else {
          api.control('olympus_settings[search_fullscreen_heading]').toggle(false);
          api.control('olympus_settings[search_fullscreen_design_heading]').toggle(false);
          api.control('olympus_settings[search_fullscreen_bg]').toggle(false);
          api.control('olympus_settings[search_fullscreen_title_color]').toggle(false);
          api.control('olympus_search_fullscreen_input_wrapper').toggle(false);
          api.control('olympus_search_fullscreen_input_border_wrapper').toggle(false);
          api.control('olympus_search_fullscreen_close_btn_wrapper').toggle(false);
        }

        if ('slide' === value) {
          api.control('olympus_settings[search_slide_heading]').toggle(true);
          api.control('olympus_search_slide_input_wrapper').toggle(true);
          api.control('olympus_search_slide_input_border_wrapper').toggle(true);
          api.control('olympus_search_slide_close_btn_wrapper').toggle(true);
        } else {
          api.control('olympus_settings[search_slide_heading]').toggle(false);
          api.control('olympus_search_slide_input_wrapper').toggle(false);
          api.control('olympus_search_slide_input_border_wrapper').toggle(false);
          api.control('olympus_search_slide_close_btn_wrapper').toggle(false);
        }
      };
    ...
    api.control('olympus_settings[add_cart_icon]', function (control) {
      var toggleControl = function toggleControl(value) {
        if (true === value) {
          api.control('olympus_settings[cart_count]').toggle(true);
          api.control('olympus_settings[cart_total]').toggle(true);
        } else {
          api.control('olympus_settings[cart_count]').toggle(false);
          api.control('olympus_settings[cart_total]').toggle(false);
        }
      };
    ...
    api.control('olympus_settings[load_css_file]', function (control) {
      var toggleControl = function toggleControl(value) {
        if (true === value) {
          api.control('olympus_settings[regenerate_external_css]').toggle(true);
        } else {
          api.control('olympus_settings[regenerate_external_css]').toggle(false);
        }
      };
    ...
    $('button.olympus-regenerate-css').on('click', function (e) {
      e.preventDefault();

      var _this = $(this),
          data = {
        action: 'olympus_regenerate_css_file',
        nonce: olympusControls.regenerate_css
      };
      ...
      $.post(ajaxurl, data, function (response) {
        if (response && response.success) {
          _this.text(olympusControls.successCSS);

          setTimeout(function () {
            _this.prop('disabled', false);

            _this.text(olympusControls.initialCSS);
          }, 1000);
        } else {
          _this.text(olympusControls.failedCSS);
    ...
    api.control('olympus_settings[load_fonts_locally]', function (control) {
      var toggleControl = function toggleControl(value) {
        if (true === value) {
          api.control('olympus_settings[preload_local_fonts]').toggle(true);
          api.control('olympus_settings[flush_local_font_files]').toggle(true);
        } else {
          api.control('olympus_settings[preload_local_fonts]').toggle(false);
          api.control('olympus_settings[flush_local_font_files]').toggle(false);
        }
      };
    ...
    $('button.olympus-regenerate-fonts').on('click', function (e) {
      e.preventDefault();

      var _this = $(this),
          data = {
        action: 'olympus_regenerate_fonts_folder',
        nonce: olympusControls.regenerate_fonts
      };
      ...
      $.post(ajaxurl, data, function (response) {
        if (response && response.success) {
          _this.text(olympusControls.success);

          setTimeout(function () {
            _this.prop('disabled', false);

            _this.text(olympusControls.initial);
          }, 1000);
        } else {
          _this.text(olympusControls.failed);
 ...
 */
var BaseControl = wp.customize.olyControl = wp.customize.Control.extend({
  /**
  ...
  initialize: function initialize(id, options) {
    ...
    if (!args.params.type) {
      args.params.type = 'olympus-basic';
    }
...
/***/ "./src/customizer-controls/color-picker/OlympusColorControl.js":
/*!*********************************************************************!*\
  !*** ./src/customizer-controls/color-picker/OlympusColorControl.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (OlympusColorControl);

/***/ }),

/***/ "./src/customizer-controls/color-picker/OlympusColorControlForm.js":
/*!*************************************************************************!*\
  !*** ./src/customizer-controls/color-picker/OlympusColorControlForm.js ***!
  \*************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _OlympusColorPickerControl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./OlympusColorPickerControl */ "./src/customizer-controls/color-picker/OlympusColorPickerControl.js");
...
var OlympusColorControlForm = function OlympusColorControlForm(props) {
  /**
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    ...
    className: "olympus-component-color-picker-wrapper",
    ...
    className: "olympus-color-component-label"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", {
    className: "customize-control-title"
  }, props.label)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_OlympusColorPickerControl__WEBPACK_IMPORTED_MODULE_2__["default"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, props, {
...
/* harmony default export */ __webpack_exports__["default"] = (OlympusColorControlForm);

/***/ }),

/***/ "./src/customizer-controls/color-picker/OlympusColorPickerControl.js":
/*!***************************************************************************!*\
  !*** ./src/customizer-controls/color-picker/OlympusColorPickerControl.js ***!
  \***************************************************************************/
/*! exports provided: default */
...
var OlympusColorPickerControl = function OlympusColorPickerControl(props) {
  ...
  var value = props.value,
      ...
      tooltipText = _props$tooltipText === void 0 ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Choose Color', 'olympuswp') : _props$tooltipText,
  ...
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    var timeout = setTimeout(function () {
      setColorKey(value);
      var colorInput = document.querySelector('.olympus-color-input-wrapper input');
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "olympus-color-picker-area"
    ...
    className: "olympus-component-color-picker",
    onClose: toggleClose,
    ...
    id: "olympus-color-input-field",
    className: "olympus-color-input-main-label"
    ...
    className: "olympus-color-option-area"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "olympus-color-input-wrapper"
    ...
    onClick: function onClick() {
      ...
      setTimeout(function () {
        document.querySelector('.olympus-color-input-wrapper input').focus();
      }, 10);
    }
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Default', 'olympuswp')))))));
};

/* harmony default export */ __webpack_exports__["default"] = (OlympusColorPickerControl);
...
/* harmony import */ var _OlympusColorControl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./OlympusColorControl */ "./src/customizer-controls/color-picker/OlympusColorControl.js");
/* harmony import */ var _OlympusColorControlForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./OlympusColorControlForm */ "./src/customizer-controls/color-picker/OlympusColorControlForm.js");


var ColorControl = _OlympusColorControl__WEBPACK_IMPORTED_MODULE_0__["default"].extend(_OlympusColorControlForm__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
var DescriptionControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var EditorComponent = function EditorComponent(props) {
  ...
  var defaultParams = {
    id: 'header_html',
    toolbar1: 'formatselect | styleselect | bold italic strikethrough | forecolor backcolor | link | alignleft aligncenter alignright alignjustify | numlist bullist outdent indent | insert olympus_placeholders | fontsizeselect',
    toolbar2: ''
  };
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
    ...
    editor.addButton('olympus_placeholders', {
      type: 'menubutton',
      text: 'Tags',
      icon: false,
      menu: [{
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
    className: "olympus-control-field olympus-html-editor"
    ...
    className: "olympus-control-tinymce-editor wp-editor-area",
    id: controlParams.id,
    value: state.value,
...
var EditorControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var FontFamilyComponent = function FontFamilyComponent(props) {
  ...
  var fonts = [{
    value: '',
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Default', 'olympuswp')
  }, {
    value: 'Arial',
    label: 'Arial'
  }, {
  ...
  var weightObj = [{
    ...
    value: 'normal',
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Normal', 'olympuswp')
  }, {
    value: 'bold',
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Bold', 'olympuswp')
  }, {
    value: '100',
    label: '100'
  }, {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("label", {
    ...
    className: "oly-typo-weight-transform"
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Weight', 'olympuswp'),
    value: stateWeight,
    options: weightObj,
    ...
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Text Transform', 'olympuswp'),
    value: stateTransform,
    options: [{
      value: 'none',
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('None', 'olympuswp')
    }, {
      value: 'capitalize',
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Capitalize', 'olympuswp')
    }, {
      value: 'uppercase',
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Uppercase', 'olympuswp')
    }, {
      value: 'lowercase',
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Lowercase', 'olympuswp')
    }],
...
var FontFamilyControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var HeadingComponent = function HeadingComponent(props) {
  ...
  if (props.control.params.label) {
    htmlLabel = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("span", {
      className: "olympus-control-title"
    }, props.control.params.label);
  }

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "olympus-heading-wrapper"
  }, htmlLabel));
};
...
var HeadingControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var RadioImageComponent = function RadioImageComponent(props) {
  ...
  htmlRadio = Object.entries(choices).map(function (_ref) {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["Fragment"], {
      ...
      htmlFor: id + key,
      className: "olympus-radio-img-svg",
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("label", {
    ...
    className: "olympus-radio-images"
  }, htmlRadio));
};
...
var RadioImageControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var RespSliderComponent = function RespSliderComponent(props) {
  ...
  if (label) {
    ...
    responsiveHtml = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("ul", {
      key: 'olympus-slider-devices',
      className: "olympus-device-controls"
  ...
  if (suffix) {
    ...
    suffixHtml = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["SelectControl"], {
      key: stateSuffix,
      className: classnames__WEBPACK_IMPORTED_MODULE_6___default()('oly-unit-picker__select', state['desktop'] === 0 ? 'picker-inactive' : 'picker-active'),
      value: stateSuffix,
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    key: 'customizer-text',
    className: "olympus-title-area"
  }, labelHtml, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    className: "olympus-slider-buttons"
    ...
    className: "olympus-slider-inputs-wrapper"
...
function ResponsiveSlider(control) {
  ...
  jQuery('.customize-control-olympus-resp-slider .input-field-wrapper').removeClass('active');
  jQuery('.customize-control-olympus-resp-slider .input-field-wrapper.' + device).addClass('active');
  jQuery('.customize-control-olympus-resp-slider .olympus-device-controls li').removeClass('active');
  jQuery('.customize-control-olympus-resp-slider .olympus-device-controls li.' + device).addClass('active');
  jQuery('.wp-full-overlay-footer .devices button').on('click', function () {
    var device = jQuery(this).attr('data-device');
    jQuery('.customize-control-olympus-resp-slider .input-field-wrapper, .customize-control .olympus-device-controls > li').removeClass('active');
    jQuery('.customize-control-olympus-resp-slider .input-field-wrapper.' + device + ', .customize-control .olympus-device-controls > li.' + device).addClass('active');
  });
  control.container.find('.olympus-device-controls button').on('click', function (event) {
    event.preventDefault();
    var device = jQuery(this).attr('data-device');
    jQuery('.wp-full-overlay-footer .devices button[data-device="' + device + '"]').trigger('click');
  });
}
var RespSliderControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var SelectComponent = function SelectComponent(props) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, htmlLabel, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    ...
    className: "olympus-select-input",
    "data-name": name,
...
var SelectControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var SelectorComponent = function SelectorComponent(props) {
  ...
  var renderInputHtml = function renderInputHtml(device) {
      ...
      var _optionsHtml = Object.entries(choices).map(function (_ref) {
        ...
        if ('text' !== renderAs) {
          var html = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
            className: "olympus-alignment-inner-wrap active",
            key: value
    ...
    if ('text' !== renderAs) {
      var optionsHtml = Object.entries(choices).map(function (_ref3) {
        ...
        var html = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
          className: "olympus-alignment-inner-wrap olympus-alignment-responsive ".concat(device, " ").concat(active),
          key: value
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["Button"], {
          key: value,
          onClick: function onClick() {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
    ...
    className: "input-wrapper olympus-alignment-wrapper"
  }, inputHtml));
};
...
function ResponsiveAlign(control) {
  ...
  var device = jQuery('.wp-full-overlay-footer .devices button.active').attr('data-device');
  jQuery('.customize-control-olympus-selector .input-wrapper .olympus-alignment-responsive').removeClass('active');
  jQuery('.customize-control-olympus-selector .input-wrapper .olympus-alignment-responsive.' + device).addClass('active');
  jQuery('.customize-control-olympus-selector .input-wrapper .olympus-selector-responsive-wrap').removeClass('active');
  jQuery('.customize-control-olympus-selector .input-wrapper .olympus-selector-responsive-wrap.' + device).addClass('active');
  jQuery('.customize-control-olympus-selector .olympus-device-controls li').removeClass('active');
  jQuery('.customize-control-olympus-selector .olympus-device-controls li.' + device).addClass('active');
  jQuery('.wp-full-overlay-footer .devices button').on('click', function () {
    var device = jQuery(this).attr('data-device');
    jQuery('.customize-control-olympus-selector .input-wrapper .olympus-selector-responsive-wrap, .customize-control-olympus-selector .input-wrapper .olympus-alignment-responsive, .customize-control .olympus-device-controls > li').removeClass('active');
    jQuery('.customize-control-olympus-selector .input-wrapper .olympus-selector-responsive-wrap.' + device + ', .customize-control-olympus-selector .input-wrapper .olympus-alignment-responsive.' + device + ', .customize-control .olympus-device-controls > li.' + device).addClass('active');
  });
  control.container.find('.olympus-device-controls button').on('click', function (event) {
    event.preventDefault();
    var device = jQuery(this).attr('data-device');
...
var SelectorControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var SliderComponent = function SliderComponent(props) {
  ...
  if (suffix) {
    ...
    suffixHtml = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__["SelectControl"], {
      key: stateSuffix,
      className: classnames__WEBPACK_IMPORTED_MODULE_6___default()('oly-unit-picker__select', state === 0 ? 'picker-inactive' : 'picker-active'),
      value: stateSuffix,
      onChange: function onChange(unit) {
        setStateSuffix(unit);
        props.control.settings.sizeUnit.set(unit);
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    ...
    className: "olympus-slider-input-wrapper"
...
var SliderControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var ItemComponent = function ItemComponent(props) {
  ...
  var urlLabel = 'phone' === props.item.id ? __('Number', 'olympuswp') : __('URL', 'olympuswp');
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
    className: "olympus-sorter-item ".concat(props.item.enabled ? '' : 'is-disabled'),
    "data-id": props.item.id,
    key: props.item.id
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
    className: "olympus-sorter-item-panel-header",
    onClick: function onClick() {
      setState(function (prevState) {
        return _objectSpread(_objectSpread({}, prevState), {}, {
    ...
    className: "olympus-sorter-item-expand ".concat(props.item.enabled ? 'item-is-visible' : 'item-is-hidden'),
    onClick: function onClick(e) {
      e.stopPropagation();
    ...
    className: "olympus-sorter-title"
  }, undefined !== props.item.label && '' !== props.item.label ? props.item.label : __('Social Item', 'olympuswp')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(Button, {
    className: "olympus-sorter-item-remove",
    isDestructive: true,
    onClick: function onClick() {
    ...
    className: "olympus-sorter-item-panel-content"
...
var SocialComponent = function SocialComponent(props) {
  ...
  var defaultParams = {
    ...
    'options': [{
      value: 'facebook',
      label: __('Facebook', 'olympuswp')
    }, {
      value: 'twitter',
      label: __('Twitter', 'olympuswp')
    }, {
      value: 'instagram',
      label: __('Instagram', 'olympuswp')
    }, {
      value: 'youtube',
      label: __('YouTube', 'olympuswp')
    }, {
      value: 'facebook_group',
      label: __('Facebook Group', 'olympuswp')
    }, {
      value: 'vimeo',
      label: __('Vimeo', 'olympuswp')
    }, {
      value: 'pinterest',
      label: __('Pinterest', 'olympuswp')
    }, {
      value: 'linkedin',
      label: __('Linkedin', 'olympuswp')
    }, {
      value: 'medium',
      label: __('Medium', 'olympuswp')
    }, {
      value: 'wordpress',
      label: __('WordPress', 'olympuswp')
    }, {
      value: 'reddit',
      label: __('Reddit', 'olympuswp')
    }, {
      value: 'patreon',
      label: __('Patreon', 'olympuswp')
    }, {
      value: 'github',
      label: __('GitHub', 'olympuswp')
    }, {
      value: 'dribbble',
      label: __('Dribbble', 'olympuswp')
    }, {
      value: 'behance',
      label: __('Behance', 'olympuswp')
    }, {
      value: 'vk',
      label: __('VK', 'olympuswp')
    }, {
      value: 'xing',
      label: __('Xing', 'olympuswp')
    }, {
      value: 'rss',
      label: __('RSS', 'olympuswp')
    }, {
      value: 'email',
      label: __('Email', 'olympuswp')
    }, {
      value: 'phone',
      label: __('Phone', 'olympuswp')
    }, {
      value: 'whatsapp',
      label: __('WhatsApp', 'olympuswp')
    }, {
      value: 'google_reviews',
      label: __('Google Reviews', 'olympuswp')
    }, {
      value: 'google_play',
      label: __('Google Play', 'olympuswp')
    }, {
      value: 'telegram',
      label: __('Telegram', 'olympuswp')
    }, {
      value: 'yelp',
      label: __('Yelp', 'olympuswp')
    }, {
      value: 'twitch',
      label: __('Twitch', 'olympuswp')
    }, {
      value: 'tiktok',
      label: __('TikTok', 'olympuswp')
    }, {
      value: 'trip_advisor',
      label: __('Tripadvisor', 'olympuswp')
    }, {
      value: 'discord',
      label: __('Discord', 'olympuswp')
    }, {
      value: 'flickr',
      label: __('Flickr', 'olympuswp')
    }, {
      value: 'slack',
      label: __('Slack', 'olympuswp')
    }, {
      value: 'weibo',
      label: __('Weibo', 'olympuswp')
    }, {
      value: 'kakaotalk',
      label: __('KakaoTalk', 'olympuswp')
    }, {
      value: 'kakaostory',
      label: __('KakaoStory', 'olympuswp')
    }].sort(function (a, b) {
      if (a.value < b.value) {
        return -1;
      }
  ...
  var onDragStop = function onDragStop() {
    var dropzones = document.querySelectorAll('.olympus-builder-area');
    var i;

    for (i = 0; i < dropzones.length; ++i) {
      dropzones[i].classList.remove('olympus-dragging-dropzones');
    }
  };
  ...
  ;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
    className: "olympus-control-field olympus-sorter-items"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
    className: "olympus-sorter-row"
    ...
    className: "olympus-sorter-drop olympus-sorter-sortable-panel olympus-sorter-drop-".concat(controlParams.group),
    handle: '.olympus-sorter-item-panel-header',
    list: theItems,
    ...
    className: "olympus-social-add-area"
    ...
    className: "olympus-sorter-add-item",
    isPrimary: true,
    onClick: function onClick() {
      addItem();
    }
...
var SocialControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var SortableComponent = function SortableComponent(props) {
  ...
  var visibleMetaHtml = Object.values(value).map(function (choiceID) {
    ...
    if (choices[choiceID]) {
      html = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, inputAttrs, {
        key: choiceID,
        className: "olympus-sortable-item",
        "data-value": choiceID
  ...
  var invisibleMetaHtml = Object.keys(choices).map(function (choiceID) {
    ...
    if (Array.isArray(value) && -1 === value.indexOf(choiceID)) {
      html = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, inputAttrs, {
        key: choiceID,
        className: "olympus-sortable-item invisible",
        "data-value": choiceID
      }), choices[choiceID], Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("i", {
        className: "dashicons dashicons-visibility visibility"
      }));
...
var SortableControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var SpacingComponent = function SpacingComponent(props) {
  ...
  var onConnectedClick = function onConnectedClick() {
    ...
    var inputs = parent.querySelectorAll('.olympus-spacing-input');
  ...
  var renderResponsiveInput = function renderResponsiveInput(device) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("input", {
      ...
      className: "olympus-spacing-unit-input olympus-spacing-".concat(device, "-unit"),
  ...
  var renderInputHtml = function renderInputHtml(device) {
    ...
    var itemLinkDesc = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('Link Values Together', 'olympuswp');
    ...
    if (choices) {
      htmlChoices = Object.keys(choices).map(function (choiceID) {
        var html = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("li", _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
          ...
          className: "olympus-spacing-input-item"
        }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("input", {
          type: "number",
          className: "olympus-spacing-input olympus-spacing-".concat(device, " ").concat(connectedClass),
          "data-id": choiceID,
          ...
          className: "olympus-spacing-title"
        }, choices[choiceID]));
        return html;
      });
    }
    ...
    linkHtml = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("li", {
      ...
      className: "olympus-spacing-input-item-link ".concat(disconnectedClass)
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("span", {
      key: 'connect' + device,
      className: "dashicons dashicons-admin-links olympus-spacing-connected wp-ui-highlight",
      onClick: function onClick() {
        onConnectedClick();
      },
      title: itemLinkDesc
      ...
      className: "dashicons dashicons-editor-unlink olympus-spacing-disconnected",
      onClick: function onClick() {
        onDisconnectedClick();
      },
      title: itemLinkDesc
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("ul", {
      key: device,
      className: "olympus-spacing-wrapper ".concat(device, " ").concat(active)
  ...
  responsiveHtml = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    className: "olympus-spacing-unit"
  ...
  if (label) {
    htmlLabel = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
      ...
      className: "olympus-spacing-responsive-wrap"
    }, responsiveHtml));
  }
  ...
  inputHtml = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, renderInputHtml('desktop', 'active'), renderInputHtml('tablet'), renderInputHtml('mobile'));
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    key: 'olympus-spacing-responsive',
    className: "olympus-spacing-responsive"
  }, htmlLabel, htmlDescription, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    className: "olympus-spacing-inputs-wrapper"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
...
function ResponsiveSpacing(control) {
  ...
  var device = jQuery('.wp-full-overlay-footer .devices button.active').attr('data-device');
  jQuery('.customize-control-olympus-spacing .input-wrapper .olympus-spacing-wrapper').removeClass('active');
  jQuery('.customize-control-olympus-spacing .input-wrapper .olympus-spacing-wrapper.' + device).addClass('active');
  jQuery('.customize-control-olympus-spacing .olympus-device-controls li').removeClass('active');
  jQuery('.customize-control-olympus-spacing .olympus-device-controls li.' + device).addClass('active');
  jQuery('.wp-full-overlay-footer .devices button').on('click', function () {
    var device = jQuery(this).attr('data-device');
    jQuery('.customize-control-olympus-spacing .input-wrapper .olympus-spacing-wrapper, .customize-control .olympus-device-controls > li').removeClass('active');
    jQuery('.customize-control-olympus-spacing .input-wrapper .olympus-spacing-wrapper.' + device + ', .customize-control .olympus-device-controls > li.' + device).addClass('active');
  });
  control.container.find('.olympus-device-controls button').on('click', function (event) {
    event.preventDefault();
    var device = jQuery(this).attr('data-device');
...
var SpacingControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(SwitchComponent, [{
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
        className: "olympus-control-field olympus-switch-control"
...
var SwitchControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var TextComponent = function TextComponent(props) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "olympus-text-wrapper"
...
var TextControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
...
var WrapperControl = wp.customize.olyControl.extend({
  renderContent: function renderContent() {
    var control = this;
    ...
    var form = function form() {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
        className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({
          'olympus-customize-control-wrapper': true
...
wp.customize.controlConstructor['olympus-wrapper'] = _customizer_controls_wrapper__WEBPACK_IMPORTED_MODULE_3__["WrapperControl"];
wp.customize.controlConstructor['olympus-color'] = _customizer_controls_color_picker__WEBPACK_IMPORTED_MODULE_4__["ColorControl"];
wp.customize.controlConstructor['olympus-slider'] = _customizer_controls_slider__WEBPACK_IMPORTED_MODULE_5__["SliderControl"];
wp.customize.controlConstructor['olympus-resp-slider'] = _customizer_controls_resp_slider__WEBPACK_IMPORTED_MODULE_6__["RespSliderControl"];
wp.customize.controlConstructor['olympus-radio-image'] = _customizer_controls_radio_image__WEBPACK_IMPORTED_MODULE_7__["RadioImageControl"];
wp.customize.controlConstructor['olympus-select'] = _customizer_controls_select__WEBPACK_IMPORTED_MODULE_8__["SelectControl"];
wp.customize.controlConstructor['olympus-selector'] = _customizer_controls_selector__WEBPACK_IMPORTED_MODULE_9__["SelectorControl"];
wp.customize.controlConstructor['olympus-spacing'] = _customizer_controls_spacing__WEBPACK_IMPORTED_MODULE_10__["SpacingControl"];
wp.customize.controlConstructor['olympus-social'] = _customizer_controls_social__WEBPACK_IMPORTED_MODULE_11__["SocialControl"];
wp.customize.controlConstructor['olympus-sortable'] = _customizer_controls_sortable__WEBPACK_IMPORTED_MODULE_12__["SortableControl"];
wp.customize.controlConstructor['olympus-switch'] = _customizer_controls_switch__WEBPACK_IMPORTED_MODULE_13__["SwitchControl"];
wp.customize.controlConstructor['olympus-heading'] = _customizer_controls_heading__WEBPACK_IMPORTED_MODULE_14__["HeadingControl"];
wp.customize.controlConstructor['olympus-font-family'] = _customizer_controls_font_family__WEBPACK_IMPORTED_MODULE_15__["FontFamilyControl"];
wp.customize.controlConstructor['olympus-editor'] = _customizer_controls_editor__WEBPACK_IMPORTED_MODULE_16__["EditorControl"];
wp.customize.controlConstructor['olympus-text'] = _customizer_controls_text__WEBPACK_IMPORTED_MODULE_17__["TextControl"];
wp.customize.controlConstructor['olympus-action-button'] = _customizer_controls_action_button__WEBPACK_IMPORTED_MODULE_18__["ActionButtonControl"];
wp.customize.controlConstructor['olympus-description'] = _customizer_controls_description__WEBPACK_IMPORTED_MODULE_19__["DescriptionControl"];
